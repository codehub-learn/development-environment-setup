# Hardware and software requirements for Technical Business Analysis
&nbsp;
...
## Required software 
You will require the latest version of Excel, which can be downloaded using your Ath.Tech account by selecting **Install Apps** at https://www.office.com/.
You will also need the MS-SQL Server database (RDBMS), the MS-SQL Server management interface and the Power BI desktop application.

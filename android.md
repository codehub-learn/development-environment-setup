...
- A Mac, Windows, or Linux Computer - Ensure your system meets
  the [requirements for Android Studio](https://developer.android.com/studio/install).
...
2. Emulator Configuration - Set up a virtual Android device for testing following the instructions
   to [Create and manage virtual devices](https://developer.android.com/studio/run/managing-avds)

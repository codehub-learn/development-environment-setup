...
- Visit the [MongoDB site](https://www.mongodb.com/docs/manual/tutorial/install-mongodb-on-windows/) and follow the instruction given based on your operating system

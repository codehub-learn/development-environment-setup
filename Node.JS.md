...
- Visit the [MongoDB site](https://www.mongodb.com/docs/manual/administration/install-community/) and follow the instruction given based on your operating system
